...
import beemart.fpoly.beemart.Fragment.FragmentHoaDon;
...
//        }
    ...
    public void changeItemNav(int id) {
        if (id == 1) {
            ...
            navigationView.getMenu().findItem(R.id.menuDoanhSo).setVisible(false);
            ...
            navigationView.getMenu().add(R.id.menu1, IDHOADON, 15, "Hóa đơn").setIcon(R.drawable.icon_hoadon);
...
//            ReplaceScreen(FragmentHoaDon.newInstance(), 1);
            ...
            changeBackgroundItem(check,item,"Hóa đơn");
        }else if(id == IDVI){
            ReplaceScreen(FragmentVi.newInstance(), 1);
            changeBackgroundItem(check,item,"Ví");
