...
public class Order implements Serializable {
    ...
    public Order(ArrayList<GioHang> list, String tenKhachHang, Long soDienThoai, String diaChi, double tongTien, int phuongThucThanhToan, int maKH,int maNV,int maOrder,int maQuyen,int diemThuong) {
        this.list = list;
    ...
    public String getListProduct(){
        ...
        for(int i  = 0;i <list.size();i++){
            ...
            stringBuilder.append(gioHang.getTenSP());
